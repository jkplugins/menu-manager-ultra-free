...
const MenuItem = (props) => {
  ...
  return (
    ...
    <div className={("mmu-menu-item-container " + (isHidden() ? "mmu-menu-item-container--hidden" : '')) + (isBeingDraggedOver ? " mmu-menu-item-container--drag-hover " : "")} ref={draggableOptions.setNodeRef} style={style} >
